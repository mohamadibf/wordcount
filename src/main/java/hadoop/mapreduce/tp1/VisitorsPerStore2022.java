...
public class VisitorsPerStore2022 {
    public static class StoreMapper extends Mapper<Object, Text, Text, Text> {
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            String[] tokens = value.toString().split(" ");
            if (tokens.length == 4 && tokens[0].endsWith("22")) { // Filtrage des dates de 2022
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "Visitors Per Store 2022");
        job.setJarByClass(VisitorsPerStore2022.class);
